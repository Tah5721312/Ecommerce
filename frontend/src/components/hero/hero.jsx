  ...
  return (
    <Container  >
      <Box sx={{pt: 2, mt: 2.5, display: "flex", alignItems: "center", gap: 2 }}>
        <Swiper
          loop={true}
          pagination={{ dynamicBullets: true}} modules={[Pagination]}  className="mySwiper" >
  ...
  {mySlider.map((item) => {
      return (
        <SwiperSlide key={item.link} className="parent-slider">
                ...
                <Box
                  sx={{
                    // MUI، theme.breakpoints بتتيح لك تحدد قواعد تنسيق حسب حجم الشاشة
            ...
            <Stack  sx={{justifyContent: { xs: "center", sm: "left" }  }}
                  ...
                  <Button
                    sx={{px: 5,py: 1,mt: 2,backgroundColor: "#454343",
                      boxShadow: "0px 4px 16px rgba(7, 7, 7, 0.1)",
        ...
        <Box sx={{ display: { xs: "none", md: "block", minWidth: "26.6%" } }}>
          <Box sx={{ position: "relative" }}>
            ...
            <Stack
              ...
              <Link sx={{color: "#2B3445",display: "flex",alignItems: "center",gap: "5px",transition: "0.2s",
                  "&:hover": {color: "#D23F57" }}}
                href="#" underline="none"     >
                shop now
          ...
          <Box sx={{ position: "relative" }}>
            ...
            <Stack sx={{position: "absolute",top: "50%",transform: "translateY(-50%)",left: 31 }} >
              <Typography variant="caption" sx={{color: "#2B3445",fontSize: "18px",fontWeight: 300 }}>
                GAMING 4K
              </Typography>
